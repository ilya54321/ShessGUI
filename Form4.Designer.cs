namespace ShessGUI
{
  partial class Form4
  {
    ...
    private void InitializeComponent()
    {
      ...
      // comboBox1
      // 
      this.comboBox1.DisplayMember = "Player";
      ...
      // comboBox2
      // 
      this.comboBox2.DisplayMember = "Player";
      ...
      this.comboBox2.Items.AddRange(new object[] {
            ...
            "Computer(medium)",
            "Computer(hard)"});
      this.comboBox2.Location = new System.Drawing.Point(34, 111);
